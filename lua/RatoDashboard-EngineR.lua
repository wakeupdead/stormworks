...
function onDraw()
	...
	ssc(0,20,0)
	sdtb(w2+4,12,4,7,"T", -1,0)
	ssc(0,120,0)
	sdtb(w2+8,12,w2-12,7,sf("%.0f",temp), 1,0)
	ssc(0,20,0)
	sdtb(w2+4,20,4,7,"R", -1,0)
	ssc(0,120,0)
	sdtb(w2+8,20,w2-12,7,sf("%.0f",rps), 1,0)
	ssc(0,20,0)
	sdtb(w2+4,28,4,7,"Q", -1,0)
	ssc(0,120,0)
	sdtb(w2+8,28,w2-12,7,sf("%.0f",trq), 1,0)
end
